...
from vision_utils import vector_2d_angle
    ...
    def image_proc(self, image):
        ...
        if results is not None and results.pose_landmarks is not None:
            ...
            if self.move_finish:
                ...
                # 没有标定颜色且检测到当前中心颜色，且在标定状态，还没标定好(Color is not calibrated. Color of body center is detected and calibrated but the calibration isn't finished)
