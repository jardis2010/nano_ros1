...
class SearchKinematicsSolutions():
    ...
    def solveIK(self, coordinate_data, alpha, alpha1, alpha2, d=math.radians(0.2)):
        # 给定坐标coordinate_data和俯仰角alpha,以及俯仰角范围的范围alpha1, alpha2，自动寻找最接近给定俯仰角的解(the given coordinate coordinate_data and pitch angle alpha, and the pitch angle range alpha1, alpha2. Automatically find the solution closest to the given pitch angle)
